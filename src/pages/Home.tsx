      ...
      <section className="relative pt-32 sm:pt-36 pb-24 sm:pb-28 px-5 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_auto_340px] gap-6 lg:gap-8 items-center">
            {/* Left - Text */}
            <div className="z-10">
              {/* TODO: 임시 디버그 - 캐시 확인 후 노란 배경 제거 */}
              <h1 className="text-3xl sm:text-4xl lg:text-[42px] font-black leading-[2] tracking-tight text-slate-900 mb-12 bg-yellow-200 p-4 rounded-xl">
                티샷의 순간,<br />
                수백만의 시선이<br />
