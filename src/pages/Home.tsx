      ...
      <section className="relative pt-24 sm:pt-28 pb-16 sm:pb-20 px-5 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_auto_340px] gap-6 lg:gap-8 items-center">
            {/* Left - Text */}
            <div className="z-10">
              <h1 className="text-3xl sm:text-4xl lg:text-[42px] font-black leading-[1.15] tracking-tight text-slate-900 mb-5">
                티샷의 순간,<br />
                수백만의 시선이<br />
            ...
            <div className="hidden lg:flex relative justify-center items-end z-[5] -ml-16 -mt-12">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#f8fafc] via-[#f8fafc]/70 to-transparent pointer-events-none" />
                {/* Side fades */}
