        ...
        <div className="space-y-4">
          ...
          <div className="grid lg:grid-cols-3 gap-4">
            ...
            <Panel className="lg:col-span-2"
              title="오늘의 예외 처리 큐"
              right={
                <span className="inline-flex items-center h-6 px-2 rounded-lg bg-rose-50 text-rose-600 text-[12px] font-bold">
                      ...
                      {data.queue.map((q: any) => (
                        <tr key={q.id} className="border-b border-slate-50 last:border-0">
                          ...
                          <td className="py-3 min-w-[200px]">
                            ...
                            <p className="text-[12px] text-slate-500 mt-0.5">{q.sub}</p>
                          </td>
                  ...
                  <div key={m.label} className="rounded-xl border border-slate-100 bg-slate-50/60 px-3 py-3">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className={`text-[12px] font-semibold ${
                        m.ok === null ? 'text-slate-500' : m.ok ? 'text-emerald-600' : 'text-rose-500'
                      }`}>
                    ...
                    {data.batches.map((b: any) => (
                      <tr key={b.job} className="border-b border-slate-50 last:border-0">
                        <td className="px-5 py-3">
                          ...
                          <p className="text-[12px] text-slate-500">{b.schedule}</p>
                        </td>
                        ...
                        <td className="py-3">
                          {b.status ? (
                            <span className={`inline-flex h-6 px-2 rounded-lg text-[12px] font-bold ${
