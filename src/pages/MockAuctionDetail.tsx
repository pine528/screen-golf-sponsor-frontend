...
const MOCK_GOLFERS: Record<string, {
  ...
  m4: { player: '전승민 프로', bodyPart: '소매 좌측', slot: 'KLPGA', price: 2800000, timeLeft: '1일 남음', bids: 6, image: '/golfers/jeon-seungmin.jpg', instagram: '@j_min2mini', height: '168cm', birth: '1994.04.29', proSince: '2012 KLPGA 준회원', location: '경기도 하남시', career: ['2026 르꼬끄골프 앰버서더', '2022 SBS GOLF 로테이션 게임 출연', '아쿠쉬네트코리아 소속'] },
  m5: { player: '권민경 프로', bodyPart: '모자 우측', slot: 'KLPGA', price: 3000000, timeLeft: '8시간 남음', bids: 9, image: '/golfers/kwon-minkyung.jpg', instagram: '', height: '165cm', birth: '1990.06.30', proSince: '2009 KLPGA 정회원', location: '서울 용산구', career: ['2024 UDR멤버스 광고촬영', '2018 코오롱 FNC 잭니클라우스 소속', '2016-2018 SBS GOLF 다수 출연'] },
  m6: { player: '김도은 프로', bodyPart: '카라 우측', slot: 'LPGA', price: 1500000, timeLeft: '12시간 남음', bids: 4, image: '/golfers/kim-doeun.jpg', instagram: '@doeundl', height: '166cm', birth: '1999.05.25', proSince: 'LPGA T&CP CLASS A', location: '서울 강남구', career: ['LPGA Professionals', '용인대학교 골프학과 졸업', '2018 대학골프연맹 회장배 단체전 우승'] },
  m7: { player: '김현명 프로', bodyPart: '가슴 좌측', slot: 'KLPGA', price: 6000000, timeLeft: '30분 남음', bids: 23, image: '/golfers/kim-hyunmyung.jpg', instagram: '@hyunmyung_85', height: '164cm', birth: '1985.09.06', proSince: '2003 KLPGA 정회원', location: '경기도 수원시', career: ['2019 JTBC GOLF 미녀삼총사 출연', '2018 맘스터치 레전드 빅매치 MC', '2004-2009 KLPGA 정규투어 활동'] },
  m8: { player: '남우리 프로', bodyPart: '어깨 좌측', slot: 'KLPGA', price: 3800000, timeLeft: '4시간 남음', bids: 11, image: '/golfers/nam-woori.jpg', instagram: '@woori_golf', height: '164cm', birth: '1992.01.07', proSince: '2009 KLPGA 정회원', location: '서울 강남구', career: ['2024 SG골프 오사카 매치 출연', '2018-2019 JTBC SG골프 더매치 출연', '2009 KLPGA 점프투어 1차전 우승'] },
  m9: { player: '노아영 프로', bodyPart: '소매 우측', slot: 'KLPGA', price: 2200000, timeLeft: '6시간 남음', bids: 7, image: '/golfers/no-ayoung.jpg', instagram: '@aaaaa._.yoi', height: '162cm', birth: '1999.07.18', proSince: '2018 KLPGA 정회원', location: '경기도 용인시', career: ['2024 SBSGOLF 더매치 출연 3승', '2024 펀펀매치 시즌6 출연', '2018 KLPGA 점프투어 2차 우승'] },
  m10: { player: '서하경 프로', bodyPart: '허리 뒷면', slot: 'KLPGA', price: 4500000, timeLeft: '2일 남음', bids: 5, image: '/golfers/seo-hakyung.jpg', instagram: '@katie_seo', height: '166cm', birth: '1993.08.27', proSince: '2013 KLPGA 정회원', location: '서울 강남구', career: ['2023 SBS 골프아카데미 동계특집 출연', '2022 SBS SG더매치 출연', '2013 KLPGA 점프투어 11차전 우승'] },
  m11: { player: '석지우 프로', bodyPart: '모자 뒷면', slot: 'KLPGA', price: 2500000, timeLeft: '10시간 남음', bids: 3, image: '/golfers/seok-jiwoo.jpg', instagram: '@iamsukjiwoo', height: '168cm', birth: '1992.07.26', proSince: '2014 KLPGA 정회원', location: '경기도 수원시', career: ['2025-2026 에코골프 앰버서더', '2019-2021 넥시드 골프단', '2014 KLPGA 점프투어 10차전 우승'] },
};
...
export default function MockAuctionDetail() {
  ...
  const otherAuctionsList = otherAuctions && otherAuctions.length > 0
    ...
    : [
        { id: null, part: '가슴 중앙', price: 3200000, status: 'LIVE', time: '5시간' },
        ...
        <div className="grid lg:grid-cols-[1fr_360px] gap-5">
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm mt-3">
            <div className="px-3 py-2 border-b border-slate-100 flex items-center justify-between">
              <span className="text-xs font-bold text-slate-900">{displayData.player}의 다른 구좌</span>
